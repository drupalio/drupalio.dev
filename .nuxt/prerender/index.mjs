import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};export { i as closePrerenderer, l as localFetch } from './chunks/nitro/nitro.mjs';
