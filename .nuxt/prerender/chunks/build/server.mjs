import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, computed, h, ref, mergeProps, unref, withCtx, createTextVNode, createVNode, toDisplayString, hasInjectionContext, inject, toValue, getCurrentInstance, onServerPrefetch, shallowRef, resolveComponent, watch, provide, cloneVNode, createElementBlock, nextTick, toRef, isRef, defineAsyncComponent, Suspense, Fragment, useSSRContext, createApp, shallowReactive, onErrorCaptured, resolveDynamicComponent, reactive, effectScope, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/vue@3.5.39_typescript@5.9.3/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie, sanitizeStatusCode, appendHeader } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/vue-router@4.6.4_vue@3.5.39_typescript@5.9.3_/node_modules/vue-router/vue-router.node.mjs';
import { defuFn, defu } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs';
import { parseQuery, hasProtocol, joinURL, parseURL, encodePath, decodePath, isScriptProtocol, withQuery, withTrailingSlash, withoutTrailingSlash } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs';
import { parse } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/cookie-es@2.0.1/node_modules/cookie-es/dist/index.mjs';
import destr from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { isEqual } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import { createI18n } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/vue-i18n@11.4.6_vue@3.5.39_typescript@5.9.3_/node_modules/vue-i18n/dist/vue-i18n.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/vue@3.5.39_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
import { debounce } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/perfect-debounce@2.1.0/node_modules/perfect-debounce/dist/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-SyQKCPqH.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-kLdzkazc.mjs')
  },
  {
    name: "blog-slug",
    path: "/blog/:slug(.*)*",
    component: () => import('./_...slug_-TzetRvpV.mjs')
  },
  {
    name: "projects-slug",
    path: "/projects/:slug(.*)*",
    component: () => import('./_...slug_-B76-y-Xa.mjs')
  }
];
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-Chx8jga7.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-BjjvpLfN.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-BmhFoCmw.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-CvJxsEFs.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-EPKPHqwq.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-CZR1np56.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-CQewv5wL.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-Du0sZQbH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-fdV5wHjC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BCSw8-ma.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-uMjwJ038.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-CW5OILgc.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-CdM1M9WY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-DBHmvXLb.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-Deldv5Po.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-C43ouD5l.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-ChLYwSib.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-DNMyRjgr.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-BDbWR6zw.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-D0AND-tQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-CxJUaMlV.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-CcSr2NYu.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-XbIamd6u.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-kmF9u8YQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-Bu8fShGU.mjs').then((r) => r["default"] || r.default || r));
...
export { __nuxt_component_1 as _, useLanguage as a, useSeoMeta as b, useHead as c, _sfc_main$3 as d, entry_default as default, _sfc_main$2 as e, __nuxt_component_0$1 as f, useRoute as g, createError as h, useRuntimeConfig as i, useAsyncData as j, _export_sfc as k, useRequestEvent as l, fetchDefaults as m, useRequestFetch as n, tryUseNuxtApp as t, useNuxtApp as u };
