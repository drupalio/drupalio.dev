import { _ as _sfc_main$7, u as useContentQueries } from './useContentQueries-cBSYek9c.mjs';
import { a as useLanguage, b as useSeoMeta, c as useHead, d as _sfc_main$3$1, e as _sfc_main$2$1, u as useNuxtApp, _ as __nuxt_component_1 } from './server.mjs';
import { _ as _sfc_main$8 } from './NuxtImg-C3D6XDEg.mjs';
import { defineComponent, ref, resolveDirective, mergeProps, withCtx, createVNode, unref, openBlock, createBlock, createCommentVNode, computed, resolveDynamicComponent, renderSlot, withAsyncContext, defineAsyncComponent, useSSRContext } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/vue@3.5.39_typescript@5.9.3/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrGetDirectiveProps, ssrInterpolate, ssrRenderVNode, ssrRenderSlot, ssrRenderList, ssrRenderAttr } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/vue@3.5.39_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
import { _ as _sfc_main$9 } from './SectionLabel-DTsiWQLU.mjs';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const t = (key) => {
      var _a;
      if (!((_a = $i18n == null ? void 0 : $i18n.global) == null ? void 0 : _a.t)) return key;
      try {
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const links = computed(() => {
      var _a;
      const raw = (_a = $i18n == null ? void 0 : $i18n.global) == null ? void 0 : _a.tm("personalInfo.links");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(workExperience)) {
        ...
        ssrRenderList(unref(workExperience), (job) => {
          ...
          if ((_a = job.projects) == null ? void 0 : _a.length) {
            ...
            ssrRenderList(job.projects, (project, pIndex) => {
              ...
              if ((_a2 = project.technologies) == null ? void 0 : _a2.length) {
...
const __nuxt_component_8_lazy = defineAsyncComponent(() => import('./FeaturedProjects-Dx6cXO_3.mjs').then((c) => c.default || c));
const __nuxt_component_9_lazy = defineAsyncComponent(() => import('./AILabCard-CqbwL2Sd.mjs').then((c) => c.default || c));
const __nuxt_component_10_lazy = defineAsyncComponent(() => import('./GitHubCard-D0LJG8ME.mjs').then((c) => c.default || c));
const __nuxt_component_11_lazy = defineAsyncComponent(() => import('./CareerTimeline-CQNr4mk1.mjs').then((c) => c.default || c));
const __nuxt_component_12_lazy = defineAsyncComponent(() => import('./SoftSkillsCloud-D5_UCv5e.mjs').then((c) => c.default || c));
const __nuxt_component_13_lazy = defineAsyncComponent(() => import('./ContactCard-_7JbG9u1.mjs').then((c) => c.default || c));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ScrollProgress = _sfc_main$7;
      const _component_AppHeader = _sfc_main$3$1;
...
//# sourceMappingURL=index-Ih-kdekg.mjs.map
