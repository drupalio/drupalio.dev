import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, ref, mergeProps, unref, computed, toRaw, resolveComponent, defineAsyncComponent, h, getCurrentInstance, reactive, watch, Text, Comment, useSSRContext } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/vue@3.5.39_typescript@5.9.3/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrRenderSlot } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/vue@3.5.39_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
import { pascalCase, kebabCase } from 'file:///Users/drupalio/drupalio.dev/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed left-0 top-16 z-50 h-0.5 w-full bg-transparent" }, _attrs))}><div class="h-full bg-accent transition-[width] duration-75 ease-out" style="${ssrRenderStyle({ width: `${unref(progress)}%` })}"></div></div>`);
    };
  }
});
...
_sfc_main$2.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/layout/ReadingProgress.vue");
...
const _sfc_main$1 = defineComponent({
  ...
  async setup(props) {
    ...
    const customElementTags = ((_d = mdc == null ? void 0 : mdc.components) == null ? void 0 : _d.customElements) || ((_e = mdc == null ? void 0 : mdc.components) == null ? void 0 : _e.custom);
    ...
    const tags = computed(() => {
      ...
      return {
        ...
        ...toRaw(((_d2 = (_c2 = props.data) == null ? void 0 : _c2.mdc) == null ? void 0 : _d2.components) || {}),
        ...props.components
      };
    });
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxtjs+mdc@0.22.1_magicast@0.5.3/node_modules/@nuxtjs/mdc/dist/runtime/components/MDCRenderer.vue");
  ...
  setup(__props) {
    ...
    const tags = computed(() => {
      ...
      return {
        ...
        ...toRaw(((_c = propsDataMDC.value) == null ? void 0 : _c.components) || {}),
        ...props.components
      };
    });
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+content@3.15.0_@valibot+to-json-schema@1.7.1_valibot@1.4.2_typescript@5.9.3___bet_d813838a7756b496e7275e2811f16b06/node_modules/@nuxt/content/dist/runtime/components/ContentRenderer.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main$2 as _, _sfc_main as a };
//# sourceMappingURL=ContentRenderer-DK56Eka6.mjs.map
