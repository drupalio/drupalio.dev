...
// node_modules/.pnpm/@intlify+shared@11.4.6/node_modules/@intlify/shared/dist/shared.mjs
...
// node_modules/.pnpm/@intlify+message-compiler@11.4.6/node_modules/@intlify/message-compiler/dist/message-compiler.mjs
...
// node_modules/.pnpm/@intlify+core-base@11.4.6/node_modules/@intlify/core-base/dist/core-base.mjs
...
function resolveMessageFormat(context, key, locale, fallbackLocale, fallbackWarn, missingWarn) {
  ...
  for (let i = 0; i < locales.length; i++) {
    ...
    const emitter = true ? context.__v_emitter : void 0;
    if (locale !== targetLocale) {
      if (emitter) {
        emitter.emit("fallback", {
          type,
...
function getMessageContextOptions(context, locale, message, options) {
  ...
  const resolveMessage = (key, useLinked) => {
    ...
    if (val == null && (fallbackContext || useLinked)) {
      const [format3, , message2] = resolveMessageFormat(
      ...
      val = format3 ?? resolveValue2(message2, key);
    }
...
// node_modules/.pnpm/vue-i18n@11.4.6_vue@3.5.39_typescript@5.9.3_/node_modules/vue-i18n/dist/vue-i18n.mjs
import * as Vue from "vue";
import { createVNode, Text, computed, watch, ref, shallowRef, Fragment, defineComponent, h, getCurrentScope, onScopeDispose, effectScope, inject, onMounted, onUnmounted, isRef } from "vue";
